...
- `documentation.md`／`documentation_ja.md` — documentation comment、Markdown、診断
- `types.md`／`types_ja.md` — 型同一性、推論、generic、nullability、effect、関数とrecord
- `evaluation.md`／`evaluation_ja.md` — 評価順、制御フロー、error、cleanup
- `modules.md`／`modules_ja.md` — module、import、可視性、re-export、platform
- `entry-point.md`／`entry-point_ja.md` — 実行可能な`main`のsignatureと終了動作
- `tasks.md`／`tasks_ja.md` — async処理と構造化並行処理
