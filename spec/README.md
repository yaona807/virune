...
This README is the index for the Virune 1.0 normative specification. The paired rule-bearing documents listed below and `grammar.ebnf` define the normative Virune 1.0 contracts. If explanatory documentation elsewhere conflicts with those contracts, the specification takes precedence. [Runtime ABI v2](runtime-abi.md) is normative for Runtime ABI details.
