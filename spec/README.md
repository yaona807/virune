...
The files in this directory define the normative language contract for Virune 1.0. When explanatory documentation and this directory disagree, this directory takes precedence. Runtime ABI details remain normative in `runtime-abi.md`.
...
- `js-interop.md` — normative JavaScript / TypeScript interoperability contract
- `standard-library.md` — Bytes, fixed-width integers, Unicode, collection semantics
- `runtime-abi.md` — Runtime ABI v2 contract between generated code and the Runtime
