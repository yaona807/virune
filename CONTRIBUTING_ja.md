...
Security vulnerabilityの疑いを、public Issue、Discussion、Pull Request、その他のpublic channelへ公開しないでください。Private vulnerability reportingと、それが利用できない場合のfallback手順は[`SECURITY_ja.md`](SECURITY_ja.md)に従ってください。
