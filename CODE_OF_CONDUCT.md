# Virune Code of Conduct

日本語: [CODE_OF_CONDUCT_ja.md](CODE_OF_CONDUCT_ja.md)

## Adopted standard

Virune adopts the behavioral standard of [Contributor Covenant 3.0](https://www.contributor-covenant.org/version/3/0/code_of_conduct/) by version-fixed reference.

Contributor Covenant is maintained by the Organization for Ethical Source and is licensed under CC BY-SA 4.0. This file does not reproduce or relicense the Contributor Covenant text. The linked Contributor Covenant remains governed by its own license; the Virune-specific supplementary text below is project-authored repository documentation.

Participants are expected to follow the complete Contributor Covenant 3.0, including its expectations for respectful participation, restricted behavior, confidentiality, accountability, harm repair, and community scope. This supplement narrows only Virune-specific reporting and moderation mechanics; it does not remove protections from the adopted standard.

## Virune community scope

For Virune, community spaces include this repository's Issues, Pull Requests, reviews, and other official project channels that may be established later. The Contributor Covenant also applies when someone is officially representing Virune.

Technical disagreement is expected. Criticism must address code, design, evidence, or process rather than attacking a person or group.
