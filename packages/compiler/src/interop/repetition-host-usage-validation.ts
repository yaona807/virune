...
export function validateRepetitionHostTypeScriptUsage(options: RepetitionHostTypeScriptUsageOptions): boolean {
	...
	const sourceText = [
		...
		'function __viruneRequireGenericHost<T>(__viruneValue: T, __viruneIndex: number, __viruneIdentity: string): void {',
		'  const __viruneGenericResult = __viruneRepetitionHost(',
		'    () => [{ id: __viruneIdentity, index: __viruneIndex, value: __viruneValue }],',
