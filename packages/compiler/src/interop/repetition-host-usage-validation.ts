...
export function validateRepetitionHostTypeScriptUsage(options: RepetitionHostTypeScriptUsageOptions): boolean {
	...
	const sourceText = [
		...
		'function __viruneRequireGenericHost<T>(__viruneValue: T): void {',
		'  const __viruneGenericResult = __viruneRepetitionHost(',
		'    () => [{ id: "s:virune-generic-probe", index: 0, value: __viruneValue }],',
		...
		'      const __viruneRoundTripId: string = __viruneIdentity;',
		'      void __viruneRoundTripValue; void __viruneRoundTripIndex; void __viruneRoundTripId;',
		'      return <virune-probe />;',
		'    },',
		'  );',
		'  void __viruneGenericResult;',
		'}',
		'__viruneRequireGenericHost({ marker: "virune-generic-probe" });',
