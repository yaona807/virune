...
import { createSelfhostProjectKernel } from '../packages/compiler/dist/src/selfhost/project-differential-adapter.js';
...
console.log(`Self-host Project Compiler differential: ${report.passed ? 'PASS' : 'FAIL'}`);
...
function parseArguments(argumentsList) {
	let fixture = null;
	let output = '.cache/selfhost-project-differential';
