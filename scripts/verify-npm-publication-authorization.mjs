...
export function evaluateNpmPublicationAuthorization({
	...
	assert(registryPolicy.registryVersionEligible === true, '$.releaseVersion', 'publication-candidate version must be Registry-eligible');
...
export function validatePublicationManifestForAuthorization(bytes, { version, distTag, packages: planPackages }) {
